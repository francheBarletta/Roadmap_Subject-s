...
| Fecha | Día | Contenido |
|---|---|---|
| Vie 14 Ago | Vie | Libre (arranca mañana) |
| Sáb 15 Ago | Sáb | **Lógica** (~4h, + Álgebra) — **P1 ej. 1, 2, 3, 4, 5, 6** *(ver detalle abajo)* |
| Dom 16 Ago | Dom | PyE y AED2 |
| Lun 17 Ago | Lun | **Lógica** (~4h, + PyE) — **P1 ej. 7** (cierra P1) + **P2 ej. 1, 2, 3, 4, 5** |
| Mar 18 Ago | Mar | AED2 |
| Mié 19 Ago | Mié | **Lógica** (práctico, 2h) — **P2 ej. 6** (cierra P2, salvo 2c*) + **P3 ej. 1, 2** |
| Jue 20 Ago | Jue | **Lógica** (~2h) — **P3 ej. 3, 4, 5** |
| Vie 21 Ago | Vie | **Lógica** (práctico, 2h) — **P3 ej. 6, 8, 9** |
| Sáb 22 Ago | Sáb | **Lógica** (~4h, + Álgebra) — **P3 ej. 10, 11, 13** + **P4 ej. 1, 2, 3** |
| Dom 23 Ago | Dom | PyE y AED2 |
| Lun 24 Ago | Lun | **Lógica** (~4h, + PyE) — **P4 ej. 4, 5, 6, 7, 8** (cierra P4) + **P5 ej. 1** |
| Mar 25 Ago | Mar | AED2 |
| Mié 26 Ago | Mié | **Lógica** (práctico, 2h) — **P5 ej. 2, 3, 4** |
| Jue 27 Ago | Jue | **Lógica** (~2h) — **P5 ej. 5, 7** (cierra P5, salvo 6*) + **P2 ej. 2c\*** |
| Vie 28 Ago | Vie | **Lógica** (práctico, 2h — cierre general) — **P3 ej. 7\*, 12\*** + **P5 ej. 6\*** |
| Sáb 29 Ago → Vie 11 Sep | — | Sin ejercicios nuevos (temario completo). Usar Lunes/Miércoles/Jueves/Viernes/Sábado para repaso, TPs del aula virtual, y sumar las próximas 2 unidades cuando lleguen. |
| **Vie 11 Sep** | Vie | **PRIMER PARCIAL** |

> El temario de estos 5 prácticos cierra el **Vie 28 Ago** — quedan casi 2 semanas de margen antes del Primer Parcial (11 Sep) para repaso, TPs del aula virtual, y lo que se sume de las próximas unidades.

### Detalle día por día

**Sáb 15** *(~4h, + Álgebra)* — P1 ej. 1, 2, 3, 4, 5, 6
...
**Dom 16** — PyE y AED2 (no es día de Lógica)

**Lun 17** *(~4h, + PyE — cierra P1)* — P1 ej. 7 · P2 ej. 1, 2, 3, 4, 5
...
**Mar 18** — AED2 (no es día de Lógica)

**Mié 19** *(práctico, 2h — cierra P2 salvo 2c\*)* — P2 ej. 6 · P3 ej. 1, 2
...
**Vie 21** *(práctico, 2h)* — P3 ej. 6, 8, 9
...
**Sáb 22** *(~4h, + Álgebra)* — P3 ej. 10, 11, 13 · P4 ej. 1, 2, 3
* *Ej 10 (P3)* — Probar que x∨y es cota superior de {x,y} — 🎥 "Propiedades de las relaciones: reflexividad, simetría, antisimetría, transitividad" — https://www.youtube.com/watch?v=m85j8bxFqvU
* *Ej 11 (P3)* — Decidir cuáles de L1, L2, L3, L4 son complementados — 🎥 "Retículos y álgebras de Boole — parte 2" — https://www.youtube.com/watch?v=cn5_iePGK9o
...
* *Ej 1 (P4)* — Reticulado L1: complementos de a,b,d,0; ¿complementado?; ¿distributivo? — 🎥 "Ley Distributiva del Álgebra de Boole" — https://www.youtube.com/watch?v=4ZixcbkHydA
* *Ej 2 (P4)* — Diagramas L3-L11: incrustaciones, isomorfismo con Dn, distributivos, álgebra de Boole — 🎥 "Álgebra Booleana — Introducción" — https://www.youtube.com/watch?v=p58C7OWe3Xk
* *Ej 3 (P4)* — Demostrar x∨(z∧y) ≤ (x∨z)∧y; comprobar igualdad si distributivo — 🎥 "Retículos y álgebras de Boole — parte 2" — https://www.youtube.com/watch?v=cn5_iePGK9o

**Dom 23** — PyE y AED2 (no es día de Lógica)

**Lun 24** *(~4h, + PyE — cierra P4)* — P4 ej. 4, 5, 6, 7, 8 · P5 ej. 1
...
* *Ej 5 (P4)* — Demostrar: cancelativa ⟹ distributivo (Teorema M3-N5) — 🎥 "Ley Distributiva del Álgebra de Boole" — https://www.youtube.com/watch?v=4ZixcbkHydA
...
**Mar 25** — AED2 (no es día de Lógica)

**Mié 26** *(práctico, 2h)* — P5 ej. 2, 3, 4
* *Ej 2* — Relaciones de isomorfismo (D2310 vs P(5 elem.); D90 vs P(4 elem.)) — 🎥 "Ejemplo: relaciones de equivalencia" — https://www.youtube.com/watch?v=rzz92xgPVuY
* *Ej 3* — Probar que ∅ es decreciente; unión de decrecientes es decreciente — 🎥 "Relaciones de EQUIVALENCIA — Definición, Clases y Cociente" — https://www.youtube.com/watch?v=ke4FJlEe_EU
* *Ej 4* — Para cada reticulado: hallar At(L), Hasse de P(At(L)), determinar álgebras de Boole — 🎥 "Teorema de Representación de Birkhoff — ILC FAMAF" — https://www.youtube.com/watch?v=Kr-qM-TqlLs

**Jue 27** *(~2h — cierra P5 salvo 6\*)* — P5 ej. 5, 7 · P2 ej. 2c*
...
**Vie 28** *(práctico, 2h — cierre general del temario)* — P3 ej. 7*, 12* · P5 ej. 6*
