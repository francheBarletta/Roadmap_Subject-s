...
| Martes (clase 9-13 PyE + 14-18) | Lógica *(antes SR, cambiado el 1/9)* |
| Miércoles (tarde libre, ~4h) | Álgebra |
| Jueves (clase 9-13 PyE + 14-18 Álgebra) | SR — **reemplazado por AED2 Teórico-Práctico (2h, día liviano nuevo)** |
...
| Jue 15 Oct | **P2.3 ej. 1, 2, 3** |
| Dom 18 Oct | **P2.3 ej. 4, 5, 6** |
| Jue 22 Oct | **P2.3 ej. 7 (cierra P2) · P3.1 ej. 1, 2** |
| Dom 25 Oct | **P3.1 ej. 3, 5, 6** |
| Jue 29 Oct | **P3.1 ej. 9 (cierra P3 Parte 1) · P3.2 ej. 1, 2** |
| Dom 1 Nov | **P3.2 ej. 3 (cierra P3 Parte 2) · P3.3 ej. 1, 2** |
| Jue 5 Nov | **P3.3 ej. 4, 5, 7** |
| Dom 8 Nov | **P3.3 ej. 9 (cierra P3 Parte 3) · P3.4 ej. 1, 2** |
| Jue 12 Nov | **P3.4 ej. 3, 4 (cierra el temario completo)** |
| Vie 15 Nov → Mié 2 Dic | — | Sin ejercicios nuevos (temario completo desde el 12/11). Repaso general, TPs pendientes, margen amplio antes del Llamado 1. |
| **Mié 2 Dic** | **LLAMADO 1** |

> **Corrida del 1/9:** seguíamos en cero con AED2 tras varios corrimientos fallidos del sprint — se reorganizó todo con un ritmo más liviano (3 ejercicios/sesión en vez de 4-5) y un segundo día en la semana (Jueves, antes libre) para no perder margen. **Excepción solo esta semana:** el jueves 3/9 se lo lleva Álgebra (atraso puntual) — arranca en Domingo 6/9 y el jueves vuelve a su lugar el 10/9. El temario completo cierra el **jueves 12/11**, dejando más de **2 semanas de repaso** antes del Llamado 1 (2/12).
...
**Jue 22 Oct** *(2h)* — P2.3 ej. 7 (cierra P2) · P3.1 ej. 1, 2
...
**Jue 29 Oct** *(2h)* — P3.1 ej. 9 (cierra P3 Parte 1) · P3.2 ej. 1, 2
...
**Dom 1 Nov** *(2h)* — P3.2 ej. 3 (cierra P3 Parte 2) · P3.3 ej. 1, 2
...
**Dom 8 Nov** *(2h)* — P3.3 ej. 9 (cierra P3 Parte 3) · P3.4 ej. 1, 2
...
**Jue 12 Nov** *(2h)* — P3.4 ej. 3, 4 (cierra el temario completo)
