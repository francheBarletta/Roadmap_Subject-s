...
- Nada resuelto todavía. Arranca el domingo 16 de agosto.
...
**Total: 59 ejercicios** en 15 domingos activos (14 semanas × 4 ej. + 1 semana × 3 ej.), dejando el domingo 29 de noviembre libre como repaso antes del Llamado 1.
...
| Martes (clase 9-13 PyE + 14-18 Álgebra) | Libre de AED2 este cuatri (antes se usaba para AED2, ahora solo Domingo) |
...
| Fecha | Contenido |
|---|---|
| Dom 16 Ago | **P1.1 ej. 1, 3, 4, 5** *(ver detalle abajo)* |
| Dom 23 Ago | **P1.1 ej. 6, 7, 8, 10** (cierra P1 Parte 1) |
| Dom 30 Ago | **P1.2 ej. 1, 2, 3, 4** |
| Dom 6 Sep | **P1.2 ej. 5, 6** (cierra P1 Parte 2) + **P1.3 ej. 1, 2** |
| Dom 13 Sep | **P1.3 ej. 3, 4, 5, 6** (cierra P1 — Prácticos de ordenamiento y complejidad) |
| Dom 20 Sep | **P2.1 ej. 1, 2, 3, 4** |
| Dom 27 Sep | **P2.1 ej. 5, 6, 7** (cierra P2 Parte 1) + **P2.2 ej. 1** |
| Dom 4 Oct | **P2.2 ej. 2, 3, 4, 5** |
| Dom 11 Oct | **P2.2 ej. 6** (cierra P2 Parte 2) + **P2.3 ej. 1, 2, 3** |
| Dom 18 Oct | **P2.3 ej. 4, 5, 6, 7** (cierra P2 — TADs lineales y no lineales) |
| Dom 25 Oct | **P3.1 ej. 1, 2, 3, 5** |
| Dom 1 Nov | **P3.1 ej. 6, 9** (cierra P3 Parte 1) + **P3.2 ej. 1, 2** |
| Dom 8 Nov | **P3.2 ej. 3** (cierra P3 Parte 2) + **P3.3 ej. 1, 2, 4** |
| Dom 15 Nov | **P3.3 ej. 5, 7, 9** (cierra P3 Parte 3) + **P3.4 ej. 1** |
| Dom 22 Nov | **P3.4 ej. 2, 3, 4** (cierra el temario completo) |
| Dom 29 Nov | — Sin ejercicios nuevos. Repaso general, TPs pendientes, releer Práctico 0 si hace falta. |
| **Mié 2 Dic** | **LLAMADO 1** |
...
**Dom 23 Ago** *(2h — cierra P1 Parte 1)* — P1.1 ej. 6, 7, 8, 10
...
**Dom 6 Sep** *(2h — cierra P1 Parte 2)* — P1.2 ej. 5, 6 · P1.3 ej. 1, 2
...
**Dom 13 Sep** *(2h — cierra P1, Prácticos de ordenamiento/complejidad)* — P1.3 ej. 3, 4, 5, 6
...
**Dom 27 Sep** *(2h — cierra P2 Parte 1)* — P2.1 ej. 5, 6, 7 · P2.2 ej. 1
...
**Dom 11 Oct** *(2h — cierra P2 Parte 2)* — P2.2 ej. 6 · P2.3 ej. 1, 2, 3
...
**Dom 18 Oct** *(2h — cierra P2, TADs lineales y no lineales)* — P2.3 ej. 4, 5, 6, 7
...
**Dom 1 Nov** *(2h — cierra P3 Parte 1)* — P3.1 ej. 6, 9 · P3.2 ej. 1, 2
...
**Dom 8 Nov** *(2h — cierra P3 Parte 2)* — P3.2 ej. 3 · P3.3 ej. 1, 2, 4
...
**Dom 15 Nov** *(2h — cierra P3 Parte 3)* — P3.3 ej. 5, 7, 9 · P3.4 ej. 1
...
**Dom 22 Nov** *(2h — cierra el temario completo)* — P3.4 ej. 2, 3, 4
...
**Dom 29 Nov** — Sin ejercicios nuevos (temario completo). Repaso general, TPs pendientes, y si hace falta, repasar Práctico 0 (sintaxis del lenguaje).
