...
- Nada resuelto todavía. Se perdió el domingo 16/8 (imprevisto familiar) — arranca el domingo 23 de agosto.
...
| Dom 23 Ago | **P1.1 ej. 1, 3, 4, 5** *(ver detalle abajo)* |
| Dom 30 Ago | **P1.1 ej. 6, 7, 8, 10** (cierra P1 Parte 1) |
| Dom 6 Sep | **P1.2 ej. 1, 2, 3, 4** |
| Dom 13 Sep | **P1.2 ej. 5, 6** (cierra P1 Parte 2) + **P1.3 ej. 1, 2** |
| Dom 20 Sep | **P1.3 ej. 3, 4, 5, 6** (cierra P1 — Prácticos de ordenamiento y complejidad) |
| Dom 27 Sep | **P2.1 ej. 1, 2, 3, 4** |
| Dom 4 Oct | **P2.1 ej. 5, 6, 7** (cierra P2 Parte 1) + **P2.2 ej. 1** |
| Dom 11 Oct | **P2.2 ej. 2, 3, 4, 5** |
| Dom 18 Oct | **P2.2 ej. 6** (cierra P2 Parte 2) + **P2.3 ej. 1, 2, 3** |
| Dom 25 Oct | **P2.3 ej. 4, 5, 6, 7** (cierra P2 — TADs lineales y no lineales) |
| Dom 1 Nov | **P3.1 ej. 1, 2, 3, 5** |
| Dom 8 Nov | **P3.1 ej. 6, 9** (cierra P3 Parte 1) + **P3.2 ej. 1, 2** |
| Dom 15 Nov | **P3.2 ej. 3** (cierra P3 Parte 2) + **P3.3 ej. 1, 2, 4** |
| Dom 22 Nov | **P3.3 ej. 5, 7, 9** (cierra P3 Parte 3) + **P3.4 ej. 1** |
| Dom 29 Nov | **P3.4 ej. 2, 3, 4** (cierra el temario completo — último domingo antes del final, sin margen de repaso extra) |
| **Mié 2 Dic** | **LLAMADO 1** |

> Se perdió el domingo 16/8 (imprevisto familiar). Todo el cronograma se corrió una semana — esto consume exactamente el margen de repaso que tenía el plan (antes el 29/11 era libre); ahora el temario cierra justo ese día, sin colchón antes del final.

---

## Detalle día por día

**Dom 23 Ago** *(2h)* — P1.1 ej. 1, 3, 4, 5
...
**Dom 30 Ago** *(2h — cierra P1 Parte 1)* — P1.1 ej. 6, 7, 8, 10
...
**Dom 13 Sep** *(2h — cierra P1 Parte 2)* — P1.2 ej. 5, 6 · P1.3 ej. 1, 2
...
**Dom 20 Sep** *(2h — cierra P1, Prácticos de ordenamiento/complejidad)* — P1.3 ej. 3, 4, 5, 6
...
**Dom 4 Oct** *(2h — cierra P2 Parte 1)* — P2.1 ej. 5, 6, 7 · P2.2 ej. 1
...
**Dom 18 Oct** *(2h — cierra P2 Parte 2)* — P2.2 ej. 6 · P2.3 ej. 1, 2, 3
...
**Dom 25 Oct** *(2h — cierra P2, TADs lineales y no lineales)* — P2.3 ej. 4, 5, 6, 7
...
**Dom 8 Nov** *(2h — cierra P3 Parte 1)* — P3.1 ej. 6, 9 · P3.2 ej. 1, 2
...
**Dom 15 Nov** *(2h — cierra P3 Parte 2)* — P3.2 ej. 3 · P3.3 ej. 1, 2, 4
...
**Dom 22 Nov** *(2h — cierra P3 Parte 3)* — P3.3 ej. 5, 7, 9 · P3.4 ej. 1
...
**Dom 29 Nov** *(2h — cierra el temario completo)* — P3.4 ej. 2, 3, 4
